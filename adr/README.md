...
| [0019](./0019-queued-work-for-one-subject-runs-one-at-a-time.md) | Queued work for one subject runs one at a time | effect, mediator, scheduler, dashboard | platform, data-model |
