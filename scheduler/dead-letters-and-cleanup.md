...
*API Reference: [AddMetadataCleanup]({{ site.baseurl }}{% link api-reference/scheduler-api/add-metadata-cleanup.md %}) — all configuration options including `RetentionPeriod`, `CleanupInterval`, and adding custom train types to the whitelist.*
