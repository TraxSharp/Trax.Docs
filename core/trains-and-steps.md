...
Steps are the junctions along a train's route — each one does one thing:
...
Steps use constructor injection for dependencies. When a step throws, the train switches to the left track and returns the exception.
