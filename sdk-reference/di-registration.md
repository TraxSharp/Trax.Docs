...
| Page | Description |
|------|-------------|
| [Train Registration]({{ site.baseurl }}{% link sdk-reference/di-registration/train-registration.md %}) | `AddScoped/Transient/SingletonTrax.CoreRoute` methods |
| [Step Registration]({{ site.baseurl }}{% link sdk-reference/di-registration/step-registration.md %}) | `AddScoped/Transient/SingletonTrax.CoreStep` methods |
