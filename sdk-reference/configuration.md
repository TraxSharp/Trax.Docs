...
| [AddServiceTrainBus]({{ site.baseurl }}{% link sdk-reference/configuration/add-effect-train-bus.md %}) | Registers the TrainBus and discovers trains via assembly scanning |
