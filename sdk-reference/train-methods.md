...
| [Chain]({{ site.baseurl }}{% link sdk-reference/train-methods/chain.md %}) | Executes a step, wiring its input from Memory and storing its output back |
| [ShortCircuit]({{ site.baseurl }}{% link sdk-reference/train-methods/short-circuit.md %}) | Executes a step that can return early, bypassing remaining steps |
...
| [AddServices]({{ site.baseurl }}{% link sdk-reference/train-methods/add-services.md %}) | Stores DI services into Memory so steps can access them |
