...
- If your trains are discovered via [AddServiceTrainBus]({{ site.baseurl }}{% link sdk-reference/configuration/add-effect-train-bus.md %}), you don't need to register them manually — the bus handles registration automatically.
