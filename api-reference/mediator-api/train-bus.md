...
- Trains are discovered by input type at registration time (via [AddServiceTrainBus]({{ site.baseurl }}{% link api-reference/configuration/add-effect-train-bus.md %})). Each input type maps to exactly one train.
